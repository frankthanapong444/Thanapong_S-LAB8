...
class FrankBurger extends StatelessWidget {
  const FrankBurger({Key key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    var notification_add_rounded = Icons.notification_add_rounded;
    return MaterialApp(
      routes: {
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          actions: <Widget>[
            IconButton(
              icon: Icon(notification_add_rounded),
              onPressed: () {},
            ),
          ],
        ),
        drawer: Drawer(
          child: ListView(
            children: <Widget>[
              ...
              ListTile(title: Text("FrankSuperShop"), onTap: () {}),
              ListTile(
